...
If we send a request through a promise and we get an error 404 then we get the output as a response only and not as an error. If the promise is not able to send the request only then it is an error(reject)
*/
